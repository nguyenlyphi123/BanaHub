...
namespace BanaHubWeb.Models
{
	...
	public partial class SANPHAM : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<MOREIMAGE> _MOREIMAGEs;
    ...
    partial void OnLuotXemChanged();
		...
		{
			this._CTDHs = new EntitySet<CTDH>(new Action<CTDH>(this.attach_CTDHs), new Action<CTDH>(this.detach_CTDHs));
			this._MOREIMAGEs = new EntitySet<MOREIMAGE>(new Action<MOREIMAGE>(this.attach_MOREIMAGEs), new Action<MOREIMAGE>(this.detach_MOREIMAGEs));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SANPHAM_MOREIMAGE", Storage="_MOREIMAGEs", ThisKey="MaSP", OtherKey="MaSP")]
		public EntitySet<MOREIMAGE> MOREIMAGEs
		{
			get
			{
		...
		private void attach_MOREIMAGEs(MOREIMAGE entity)
		{
			this.SendPropertyChanging();
			entity.SANPHAM = this;
		}
		
		private void detach_MOREIMAGEs(MOREIMAGE entity)
		{
			this.SendPropertyChanging();
			entity.SANPHAM = null;
		}
		...
		public SANPHAM SANPHAM
		{
			...
			set
			{
							...
							|| (this._SANPHAM.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._SANPHAM.Entity = null;
						previousValue.MOREIMAGEs.Remove(this);
					}
					this._SANPHAM.Entity = value;
					if ((value != null))
					{
						value.MOREIMAGEs.Add(this);
						this._MaSP = value.MaSP;
					}
					else
					{
